...
<html lang="en">
    ...
    <body>
        ...
        <section class="content lifeContent">
            ...
            <a data-target="#add-modal" data-toggle="modal" class="add_s" href="#">Add New Special Icon</a>
            <a class="add_s delete_all" href="javascript:void(0)">Delete All Selected</a>
            <div class="contentPd">
                <h2 class="mainHEading mainsubheading">User Special Icons</h2>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">Delete Special Icon</h4>
                                        </div>
                                        <div class="modal-body">
                                            <p>Are you sure you want to delete the special Icon ?</p>
                                        </div>
                                        <div class="modal-footer">
                                            <button onlick="#" class="gener-delete"><a href="<?php echo asset('delete_special_icon/' . $icon->id); ?>">Confirm</a></button>
        ...
        <div class="modal fade" id="add-modal" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?php echo asset('add_special_icon') ?>" method="POST" enctype="multipart/form-data" style="padding: 0px;">
        ...
        <?php include resource_path('views/admin/includes/footer.php'); ?>
          ...
          <script>
            ...
            $.ajax({
            url: base_url + '/change_special_icon_image',
                    method : "POST",
                    data: image,
                    contentType:false,
                    processData:false,
                    ...
                    alert('image must have dimentions 60x60.');
                    } else{
            ...
            $('.delete_all').on('click', function (e) {
                ...
                if (allVals.length <= 0)
                {
                    ...
                    if (check == true) {
                        ...
                        $.ajax({
                            url: '<?= asset('delete_multiple_special_icons') ?>',
                            type: 'POST',
