...
<html lang="en">
    ...
    <body>
        ...
        <section class="content lifeContent">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?php echo asset('add_article_category') ?>" method="POST" enctype="multipart/form-data" style="padding: 0px;">
                            ...
                            <div class="modal fade" id="delete-modal-<?= $cat->id; ?>" role="dialog">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button onlick="#" class="gener-delete"><a href="<?php echo asset('delete_category/' . $cat->id); ?>">Confirm</a></button>
        ...
        <script>
            ...
            $.ajax({
            url: '<?= asset('delete_multiple_artical_categories') ?>',
                    type: 'POST',
