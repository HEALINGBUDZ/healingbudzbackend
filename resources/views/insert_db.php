    ...
    <body onLoad="initGeolocation();">
        <section class="container">
            <div class="login">
                ...
                <form method="post" action="<?php echo asset('/insert_db');?>">
                    <input type="hidden" name="_token" value="<?php echo csrf_token();?>">
                    <input type="number" NAME="id" ID="lat" VALUE="" placeholder="ID" autocomplete="off">
                    <input type="number" NAME="from" ID="lng" VALUE="" placeholder="from" autocomplete="off">
                    <input type="number" NAME="to" ID="lat" VALUE="" placeholder="to" autocomplete="off">
