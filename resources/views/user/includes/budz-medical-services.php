<div id="medical-services" class="tab-pane fade <?php if (isset($_GET['tab']) && $_GET['tab'] == 'product') { ?>  active in <?php } ?>">
    <div class="">
        <?php if ($budz->user_id == $current_id) { ?>
            <div class="cus-btns">
                <?php if ($budz->subscriptions) { ?> 
                    <a href="#add-product" class="btn-popup btn-primary"><i class="fa fa-plus-square" aria-hidden="true"></i>Add Product</a>
                    <a href="#add-service" class="btn-popup btn-primary green-bg"><i class="fa fa-handshake-o" aria-hidden="true"></i> Add Service</a>
                <?php } else { ?>
                    Please Subscribe
                <?php } ?>
            </div>
        <?php } ?>
        <div class="float-clear new-produ-main">
            <?php if (count($budz->services) > 0) { ?>
                <div class="pad-bor pad-bor-nor">
                    <h4>Services</h4>
                    <div class="doctor-main">
                        <?php foreach ($budz->services as $service) {
                            $i = 1; ?>
                            <div class="doctor-price">
                                <?php
                                if ($service->image) {
                                    $path = asset(image_fix_orientation('public/images' . $service->image));
                                } else {
                                    $path = asset('userassets/images/placeholder.jpg');
                                }
                                ?>
                                <a style="<?= $i != 1 ? 'display: none;' : '' ?>" class="new-produ-list-img" href="<?php echo $path ?>" data-fancybox="<?= $service->id ?>">
        ...
        <?php if ($service->subUser->user_id == $current_id) { ?>
                                                    <a href="#update-service<?= $service->id ?>" class="share-icon btn-popup"><i class=" fa fa-edit"></i></a>
                                                    <a href="javascript:void(0)" data-toggle="modal" data-target="#delete_service<?= $service->id ?>">

                                                        <i class="fa fa-trash" aria-hidden="true"></i></a>
        <?php } ?>
                                                <a href="#share-post<?= $service->id ?>" class="share-icon btn-popup"><i class="fa fa-share-alt "></i></a>
                                            </div> 
                                            <div class="custom-shares">
                                                <?php
//                                                $url_to_share = urlencode(asset("get-budz?business_id=" . $budz->id . "&business_type_id=" . $budz->business_type_id));
//                                                echo Share::page($url_to_share, $budz->title, ['class' => 'budz_services_class', 'id' => $budz->id])
...
//                                                        ->googlePlus($budz->description);
                                        ...
                                        <?php $charges = explode('.', $service->charges) ?>
        ...
        <?php } ?>
                            ...
                            <!-- social share popup -->
                            <div id="share-post<?= $service->id ?>" class="popup alert">
        ...
        <?php } ?> </div>
                            ...
                            <!--Update service-->
                            <div id="update-service<?= $service->id ?>" class="popup inp-pop">
                                <div class="popup-holder">
                                    <div class="popup-area">
                                        <div class="text">
                                            ...
                                            <form action="<?php echo asset('add-service') ?>" class="add-service-form" id="" method="post" enctype="multipart/form-data">
                                                ...
                                                <input type="hidden" name="file_removed" id="file_removed<?php echo $service->id; ?>" value="">
                                                <fieldset>
                                                    <div class="upl-row" style="justify-content: space-between;">
                                                        <label for="s-image<?= $service->id ?>">
                                                            <img src="<?php echo asset('userassets/images/gallery-big.png') ?>" alt="Gallery Icon">
                                                            <span>Upload Photo</span>
                                                        </label>
                                                        <input  accept="image/*" type="file" id="s-image<?= $service->id ?>" class=" update_service_new hidden" alt="<?= $service->id ?>" name="image" date-id="<?= $service->id ?>">
                                                        <!--                            <label for="update_service_new">
                                                                                        
                                                                                        <span>Upload Photo</span>
                                                                                    </label>-->
                                                        <div class="uploading-image-edit  img-ajd-icon" >

                                                            <a <?php if (!$service->image) { ?> style="display: none" <?php } ?> id="close_span<?= $service->id ?>" href="javascript:void(0)" class="btn-remove" onclick="removeFileDynamic('s-image<?= $service->id ?>', 'image_upload<?= $service->id ?>', 'close_span<?= $service->id ?>', '<?php echo $service->id; ?>')">
                                                                <i class="fa fa-times" aria-hidden="true"></i>
                                                            </a>
                                                            <img class="<?= $service->image ? '' : 'hidden' ?>" <?php if ($service->image) { ?> style="display: block !important" <?php } ?> id="image_upload<?= $service->id ?>" src="<?= asset('public/images/' . $service->image) ?>" alt="image">
                                                        </div>
                                                    </div>
                                                    <div class="s-row">
                                                        <label for="s-name">Name</label>
                                                        <input value="<?= $service->name ?>" autocomplete="off" maxlength="30" type="text" id="s-name" name="service_name" required="" class="inp-cls" placeholder="Type service name..">
                                                        <label for="s-charges">Charges</label>
                                                        <input value="<?= round($service->charges) ?>" autocomplete="off"  type="number"  min="0" max="9999"  id="s-charges" name="service_charges" step="any" required="" class="inp-cls" placeholder="Add amount.. Max 9999">
                                                    </div>
                                                    <div class="s-row">
                                                    ...
                                                    <div class="s-row">
                                                        <div class="s-col">
                                                            <!--<label for="s-image" class="s-file-label purple">Upload Image</label>-->

                                                        </div>
                                                        <div class="">
                                                            <input type="submit" value="Submit Service" class="s-file-label">
                                                        </div>
                                                    </div>
                                                </fieldset>
                                            </form>
                            ...
                            <div class="modal fade" id="delete_service<?= $service->id ?>" role="dialog">
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <a href="<?php echo asset('delete-service/' . $service->id); ?>" type="button" class="btn-heal">yes</a>
                    ...
                    if ($group->menu_cat_id) {
                        foreach ($budz->products->where('menu_cat_id', $group->menu_cat_id) as $product) {
                            ...
                            if ($product->menu_cat_id) {
                                ...
                                ?>
                                <!-- social share popup -->
                                <div id="share-post<?= $product->id ?>" class="popup alert">
                                    <div class="popup-holder">
                                        <div class="popup-area">
                                            <div class="reporting-form">
                                                <h2>Select an option</h2>
                                        ...
                                        <fieldset>
                                            <div class="upl-row">
                                                <div class="fields fluid">
                                                    <div class="align-left">
                                                        <input  max="5" class="custom-file file" product-id="<?= $product->id ?>" id="file<?= $product->id ?>" type="file" name="file[]" multiple accept="image/*" style="display: none;">
                                                        <label for="file<?= $product->id ?>" class="file-label" >Attachments <span>Max 5</span></label>
                                                    </div>
                                                    <ul id="imagePreview<?= $product->id ?>" class="uploaded-files list-none">
        <?php if (!$product->images->isEmpty()) { ?>
            <?php foreach ($product->images as $productImage) { ?>
...
<?php } if (count($budz->products) == 0 && count($budz->services) == 0) { ?>
                No Product and service 
<?php } ?>
        </div>
    </div>
</div>
<div id="add-service" class="popup inp-pop">
    <div class="popup-holder">
        <div class="popup-area">
            <div class="text">
                <header class="header low-pad">
                ...
                <form action="<?php echo asset('add-service') ?>" class="add-service-form" id="service" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                    <input type="hidden" name="sub_user_id" value="<?php echo $budz->id; ?>">
                    <input type="hidden" name="business_type_id" value="<?php echo $budz->business_type_id; ?>">
                    ...
                    <fieldset>
                        <div class="upl-row" style="justify-content: space-between;">
                            ...
                            <div id="image_div" class="uploading-image img-ajd-icon">
                        ...
                        <div class="s-row">
                            <label for="s-name">Name</label>
                            <input autocomplete="off" maxlength="30" type="text" id="s-name" name="service_name" required="" class="inp-cls" placeholder="Type service name..">
                            <label for="s-charges">Charges</label>
                            <input  autocomplete="off"  type="number" min="0" max="9999" id="s-charges" name="service_charges" step="any" required="" class="inp-cls" placeholder="Add amount.. Max 9999">
                        </div>
                        <div class="s-row">
                            <!--<div class="uploading-image"><img id="image_upload" src="#" alt="image"></div>-->
                        </div>
                        <div class="s-row">
                            <div class="s-col">
                                <!--<label for="s-image" class="s-file-label purple">Upload Image</label>-->
                                <input accept="image/*" type="file" id="s-image" class="hidden" name="image">
                            </div>
                            <div class="">
                                <input type="submit" value="Submit Service" class="s-file-label">
                            </div>
...
<?php } ?>
                        ...
                        <div class="s-row">
                            ...
                            <div class="s-col">
                                <label for="price1">Price 1</label>
                                <input max="9999"  autocomplete="off"  type="number" id="price1" name="price1" min="0"  required="" step="any" class="inp-cls" placeholder="Add amount.. Max 9999">
                            </div>
                        </div>
                        <div class="s-row">
                            <div class="s-col">
...
//        }
    ...
    $('.budz_services_class').unbind().click(function () {
        count = 0;
