...
<script src="<?php echo asset('userassets/js/popup2.3.js') ?>"></script>
...
<script>
    var c_url = '<?= urlencode(Request::fullUrl()); ?>';
    $("[data-fancybox]").fancybox({
        share: {
            tpl:
                    ...
                    '<li><a class="social-button social-facebook posts_class" href="https://www.facebook.com/sharer/sharer.php?u=' + c_url + '">' +
                    '<span class="fa fa-facebook"></span></a></li>' +
                    '<li><a class="social-button social-twitter posts_class" href="https://twitter.com/intent/tweet?url=' + c_url + '">' +
                    '<span class="fa fa-twitter"></span></a></li>' +
                    '<li><a class="social-button social-gplus posts_class" href="https://plus.google.com/share?url=' + c_url + '">' +
    ...
    $(document).ready(function () {
        ...
        elems.forEach(function (html) {
            var switchery = new Switchery(html, {color: 'rgba(255,255,255,0.5)', secondaryColor: '#6e6e6e', jackColor: '#fff'});
        });
    });
</script>
<script>
...
//            OneSignal.init({
//                appId: "4d45602b-c1af-4de2-94eb-e6ed693160eb",
//                safari_web_id: 'web.onesignal.auto.2b3f64b2-7083-4ec5-9c09-3f8119751fed'
//            });

//            OneSignal.deleteTags(["user_id"]).then(function(tagsDeleted) {
//                alert(tagsDeleted);
//                window.location.href = '<?php echo asset('userlogout'); ?>';
//            });
            OneSignal.deleteTags(["user_id"]);
            window.location.href = '<?php echo asset('userlogout'); ?>';
//            OneSignal.deleteTags(["user_id"], function(tagsDeleted) {
...
//                $('#showfollowsuccess').show().html("Keyword Followed Successfully").fadeOut(3000);
    ...
    jQuery('body').on('click', '.hb_tag_btn', function (e) {
        e.preventDefault();
        jQuery(this).parents('.reporting-form').find('.to_whom').slideToggle();
    });
            ...
            <div class="hb_popup_inner_container">
                ...
                <div class="in_app_share_body">
                    ...
                    <div class="in_app_share_btn">
                        <a href="javascript:void(0)" onclick="submitSharedPost()">Share</a>
                    </div>
                </div>
