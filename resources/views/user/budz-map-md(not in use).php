                        ...
                        <ul class="btns list-none">
                            ...
                            <li style="position: relative" class="li-icon "><a href="#" class="share-icon"><i class="fa fa-share-alt "></i></a>
                                <div class="custom-shares">
                                    <?php echo Share::page(asset('get-budz/' . $budz->id), $budz->title)->facebook($budz->description)->twitter($budz->description)->googlePlus($budz->description); ?>
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="bud-map-info-bot">
                    <div class="map-cus-tabs">
                        ...
                        <div class="tab-content">
                            <?php include 'includes/budz-bus-md.php'; ?>
                            <?php include 'includes/budz-pro-md.php'; ?>
