    ...
    <body>
        <main class="error-404-page">
            <div class="error-404-bg">
                <img src="<?php echo asset('userassets/images/error404.png') ?>" alt="Image">
                <h3>Oops, something's gone wrong</h3>
                <p>It seems we couldn't find the page you're looking for.</p>
                <a href="<?php echo asset('/')?>">Go Home !</a>
            </div>
        </main>
