...
class Response
{
    ...
    public function respond(array $response = [], array $headers = []){
        ...
        $response['access_token'] = (isset($response['access_token']))?$response['access_token']:$this->getAuthorizationHeader();
    ...
    public function respondEmailVerificationFails($messages = ["Your email is not verified yet!"])
    {
        return $this->setHttpStatus(451)->setCustomStatus(451)->setErrorMessages($messages)->respondWithErrors();
    }
